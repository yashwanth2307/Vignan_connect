...
import { CreatePlacementDriveDto, ApplyPlacementDto, UpdateApplicationStatusDto } from './dto/placement.dto';
...
export class PlacementsController {
    ...
    async applyToDrive(@Param('id') driveId: string, @Req() req: any, @Body() dto: ApplyPlacementDto) {
