...
export class CreateFacultyDto {
    ...
    @ApiPropertyOptional({ example: 'faculty@FAC001', description: 'Defaults to faculty@{empId} if not provided' })
    ...
    @ApiPropertyOptional({ enum: [UserRole.FACULTY, UserRole.HOD, UserRole.EXAM_CELL] })
