...
export class CourseOfferingsService {
    ...
    async create(dto: CreateCourseOfferingDto) {
        ...
        if (existing) throw new ConflictException('Course offering already exists for this subject+section+semester');
        return this.prisma.courseOffering.create({
            ...
            include: { subject: true, section: { include: { department: true } }, faculty: { include: { user: true } }, semester: true },
        });
    }
