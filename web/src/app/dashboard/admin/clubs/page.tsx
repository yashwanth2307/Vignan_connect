                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                            ...
                            <Card className="h-full hover:shadow-xl transition-all border border-[hsl(var(--border))]/50 overflow-hidden relative">
                                ...
                                <CardHeader className="pb-3">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <Badge variant="outline" className="bg-indigo-50 text-indigo-600 border-indigo-200 dark:bg-indigo-950 dark:text-indigo-300">
                                            {c.category}
                                        </Badge>
                                    </div>
                    ...
                    {clubs.length === 0 && (
                        <div className="col-span-full py-12 text-center text-[hsl(var(--muted-foreground))]">
                            ...
                            No clubs have been formed yet. Create one above.
                        </div>
                    )}
                </div>
            )}
